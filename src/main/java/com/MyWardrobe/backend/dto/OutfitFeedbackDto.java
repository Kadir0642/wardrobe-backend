...
// Jackson : JSON <-> Java Nesnesi dönüşümünü sağlayan kütüphanedir
...
//Neden @NoArgsConstructor Şart? Jackson çok "gelenekçidir". Bir nesne oluştururken önce kapıyı çalar ve "İçeride kimse olmayan boş bir oda var mı?" diye sorar. İşte o boş oda senin NoArgsConstructor'ındır. O olmazsa içeri giremez ve hata verir

@Data // getter, setter, equals, hashCode ve toString metodlarını otomatik ekleyerek kodu tertemiz tutar
...
public class OutfitFeedbackDto { // Özetle: Şu an mobil uygulamanın anlayacağı dilden (JSON) Java'nın anlayacağı dile (POJO) bir köprü kuruyorsun. Spring Boot ve Jackson da bu işin hamallığını yapıyor
